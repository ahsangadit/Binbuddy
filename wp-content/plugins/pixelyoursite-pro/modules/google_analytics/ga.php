...
class GA extends Settings implements Pixel {
	...
	public function getEventData( $eventType, $args = null ) {
		...
		switch ( $eventType ) {
            ...
            case 'woo_affiliate':
                $data =  $this->getWooAffiliateEventParams( $args );break;
        ...
        if($data && $this->isUse4Version()) {
            ...
            $data['params']['event_url'] = \PixelYourSite\getCurrentPageUrl();
	...
	private function getWooAddToCartOnButtonClickEventParams( $product_id ) {
		...
		$dyn_remarketing = array(
			...
			'page_type'   => 'cart',
			'total_value' => getWooProductPriceToDisplay( $product_id, 1 ),
		);
