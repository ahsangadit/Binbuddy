...
function getWooSingleAddToCartParams( $_product_id, $qty = 1, $is_external = false ) {
	...
	if ( PixelYourSite\PYS()->getOption( $value_enabled_option ) ) {
		...
		$params['value']    = PixelYourSite\getWooEventValue( $value_option, $global_value, $percents_value, $_product_id ,$qty);
...
function getWooPurchaseParams( $context ,$filter = null) {
